namespace CqrsMediatrExamples.Entities
{
    public class FakeDataStore
    {
        ...
        public FakeDataStore()
        {
            _products = new List<Product>()
            {
                ...
                new Product{Id = 6, Name = "Test Product 6"},
            };
        }
        ...
        public async Task<IList<Product>> GetAllProducts() => await Task.FromResult(_products);
